...
import static appcloudservices.implementation.handlers.OpenIDHandler.OPENID_RETURN_URL;
...
public class IdentityProviderMetaDataCache {
    ...
    private static IdentityProviderMetaData loadConfiguration() throws Exception {
        ...
        try {
            ...
            final URI redirectUri = new URI(OPENID_RETURN_URL);

            return new IdentityProviderMetaData(clientId, decryptedClientSecret, providerMetadata,
                    idTokenValidator, redirectUri, new ResponseType(ResponseType.Value.CODE));
