...
public class Token
{
	 ...
	 */
	public static final java.lang.String entityName = "AppCloudServices.Token";
	...
	public enum MemberNames
	{
		...
		Value("Value"),
		SessionId("SessionId"),
		Token_User("AppCloudServices.Token_User");
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "AppCloudServices.Token"));
	}
	...
	protected Token(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject tokenMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("AppCloudServices.Token", tokenMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a AppCloudServices.Token");
	...
	public static appcloudservices.proxies.Token initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return appcloudservices.proxies.Token.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static appcloudservices.proxies.Token initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new appcloudservices.proxies.Token(context, mendixObject);
	}

	public static appcloudservices.proxies.Token load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return appcloudservices.proxies.Token.initialize(context, mendixObject);
	}

	public static java.util.List<appcloudservices.proxies.Token> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<appcloudservices.proxies.Token> result = new java.util.ArrayList<appcloudservices.proxies.Token>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//AppCloudServices.Token" + xpathConstraint))
			result.add(appcloudservices.proxies.Token.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final appcloudservices.proxies.Token that = (appcloudservices.proxies.Token) obj;
