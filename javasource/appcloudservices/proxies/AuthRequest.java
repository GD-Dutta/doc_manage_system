...
public class AuthRequest
{
	 ...
	 */
	public static final java.lang.String entityName = "AppCloudServices.AuthRequest";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "AppCloudServices.AuthRequest"));
	}
	...
	protected AuthRequest(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject authRequestMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("AppCloudServices.AuthRequest", authRequestMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a AppCloudServices.AuthRequest");
	...
	public static appcloudservices.proxies.AuthRequest initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return appcloudservices.proxies.AuthRequest.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static appcloudservices.proxies.AuthRequest initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new appcloudservices.proxies.AuthRequest(context, mendixObject);
	}

	public static appcloudservices.proxies.AuthRequest load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return appcloudservices.proxies.AuthRequest.initialize(context, mendixObject);
	}

	public static java.util.List<appcloudservices.proxies.AuthRequest> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<appcloudservices.proxies.AuthRequest> result = new java.util.ArrayList<appcloudservices.proxies.AuthRequest>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//AppCloudServices.AuthRequest" + xpathConstraint))
			result.add(appcloudservices.proxies.AuthRequest.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final appcloudservices.proxies.AuthRequest that = (appcloudservices.proxies.AuthRequest) obj;
	...
	{
		return "AppCloudServices.AuthRequest";
	}
