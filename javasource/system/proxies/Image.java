...
public class Image extends system.proxies.FileDocument
{
	...
	{
		if (com.mendix.core.Core.isSubClassOf("DocManagement.EventPhoto", mendixObject.getType()))
			return docmanagement.proxies.EventPhoto.initialize(context, mendixObject);

		if (com.mendix.core.Core.isSubClassOf("DocManagement.Session", mendixObject.getType()))
