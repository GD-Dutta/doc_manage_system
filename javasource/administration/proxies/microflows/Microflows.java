...
public class Microflows
{
	...
	public static java.util.List<docmanagement.proxies.Attendee> setupAttendees(IContext context)
	{
		try
		{
			Map<java.lang.String, Object> params = new HashMap<java.lang.String, Object>();
			java.util.List<IMendixObject> objs = Core.execute(context, "Administration.SetupAttendees", params);
			java.util.List<docmanagement.proxies.Attendee> result = null;
			if (objs != null)
			{
				result = new java.util.ArrayList<docmanagement.proxies.Attendee>();
				for (IMendixObject obj : objs)
	...
	public static java.util.List<docmanagement.proxies.Session> setupSessions(IContext context)
	{
		try
		{
			Map<java.lang.String, Object> params = new HashMap<java.lang.String, Object>();
			java.util.List<IMendixObject> objs = Core.execute(context, "Administration.SetupSessions", params);
			java.util.List<docmanagement.proxies.Session> result = null;
			if (objs != null)
			{
				result = new java.util.ArrayList<docmanagement.proxies.Session>();
				for (IMendixObject obj : objs)
