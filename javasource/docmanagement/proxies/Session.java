...
public class Session extends system.proxies.Image
{
	 ...
	 */
	public static final java.lang.String entityName = "DocManagement.Session";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "DocManagement.Session"));
	}
	...
	protected Session(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject sessionMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("DocManagement.Session", sessionMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a DocManagement.Session");
	}
	...
	public static docmanagement.proxies.Session initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return docmanagement.proxies.Session.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static docmanagement.proxies.Session initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new docmanagement.proxies.Session(context, mendixObject);
	}

	public static docmanagement.proxies.Session load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return docmanagement.proxies.Session.initialize(context, mendixObject);
	}

	public static java.util.List<docmanagement.proxies.Session> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<docmanagement.proxies.Session> result = new java.util.ArrayList<docmanagement.proxies.Session>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//DocManagement.Session" + xpathConstraint))
			result.add(docmanagement.proxies.Session.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final docmanagement.proxies.Session that = (docmanagement.proxies.Session) obj;
