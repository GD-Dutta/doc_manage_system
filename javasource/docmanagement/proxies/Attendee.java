...
public class Attendee
{
	 ...
	 */
	public static final java.lang.String entityName = "DocManagement.Attendee";
	...
	{
		this(context, com.mendix.core.Core.instantiate(context, "DocManagement.Attendee"));
	}
	...
	protected Attendee(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject attendeeMendixObject)
	{
		...
		if (!com.mendix.core.Core.isSubClassOf("DocManagement.Attendee", attendeeMendixObject.getType()))
			throw new java.lang.IllegalArgumentException("The given object is not a DocManagement.Attendee");
	...
	public static docmanagement.proxies.Attendee initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		return docmanagement.proxies.Attendee.load(context, mendixIdentifier);
	}
	 ...
	 */
	public static docmanagement.proxies.Attendee initialize(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixObject mendixObject)
	{
		return new docmanagement.proxies.Attendee(context, mendixObject);
	}

	public static docmanagement.proxies.Attendee load(com.mendix.systemwideinterfaces.core.IContext context, com.mendix.systemwideinterfaces.core.IMendixIdentifier mendixIdentifier) throws com.mendix.core.CoreException
	{
		com.mendix.systemwideinterfaces.core.IMendixObject mendixObject = com.mendix.core.Core.retrieveId(context, mendixIdentifier);
		return docmanagement.proxies.Attendee.initialize(context, mendixObject);
	}

	public static java.util.List<docmanagement.proxies.Attendee> load(com.mendix.systemwideinterfaces.core.IContext context, java.lang.String xpathConstraint) throws com.mendix.core.CoreException
	{
		java.util.List<docmanagement.proxies.Attendee> result = new java.util.ArrayList<docmanagement.proxies.Attendee>();
		for (com.mendix.systemwideinterfaces.core.IMendixObject obj : com.mendix.core.Core.retrieveXPathQuery(context, "//DocManagement.Attendee" + xpathConstraint))
			result.add(docmanagement.proxies.Attendee.initialize(context, obj));
		return result;
	}
	...
	public boolean equals(Object obj)
	{
		...
		{
			final docmanagement.proxies.Attendee that = (docmanagement.proxies.Attendee) obj;
